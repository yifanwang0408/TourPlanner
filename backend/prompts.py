...
prompt4 = (
    ...
    "Today is: {today_date}"
    "Target validation category: {travel_info_category}\n\n"
    "User input JSON:\n"
    "```\n"
    "{user_input}\n"
    "```\n\n"
    "Validation rules:\n"
    "1. If the category is 'weather':\n"
    "   - The city must be a real city.\n"
    "   - The date must be a valid calendar date.\n"
    "2. If the category is 'direction':\n"
    "   - The start_longitude, start_latitude, end_longitude, and end_latitude must be within valid Earth coordinate ranges.\n"
    "3. If the category is 'flight':\n"
    "   - The airport IATA code ('airport' field) must exist.\n"
    "   - The flight type must be either 'arrival' or 'departure'.\n"
    "   - The date must be a valid calendar date.\n"
    "4. If the category is 'hotel':\n"
    "   - The city must be a real city.\n"
    "   - The countryCode must exist and match the city.\n"
    "   - The min_rating must be between 0.0 and 10.0. Integer and string representing number are accepted.\n"
    "   - The star_rating must be between 1.0 and 5.0 inclusive, with allowed decimals '.0' or '.5' (e.g., 3.5, 4.0, 5.0). Integers, float, and strings representing numbers are accepted.\n\n"
